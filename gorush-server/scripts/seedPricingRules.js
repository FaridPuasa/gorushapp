...
const ROWS = [
    ...
    { product: 'pharmacymoh', district: 'Brunei', chargeCode: 'Standard', price: 4, note: '2-3 working days after medicine collected from Pharmacy' },
    { product: 'pharmacymoh', district: 'Tutong', chargeCode: 'Standard', price: 4, note: '2-3 working days after medicine collected from Pharmacy' },
    { product: 'pharmacymoh', district: 'Temburong', chargeCode: 'Standard', price: 4, note: '2-3 working days after medicine collected from Pharmacy' },
    { product: 'pharmacymoh', district: 'Belait', chargeCode: 'Standard', price: 4, note: '2-3 working days after medicine collected from Pharmacy' },
    { product: 'pharmacymoh', district: 'Brunei', chargeCode: 'Self Collect', price: 4, note: 'Next working day after medicine collected from Pharmacy' },
    { product: 'pharmacymoh', district: 'Tutong', chargeCode: 'Self Collect', price: 4, note: 'Next working day after medicine collected from Pharmacy' },
    { product: 'pharmacymoh', district: 'Temburong', chargeCode: 'Self Collect', price: 4, note: 'Next working day after medicine collected from Pharmacy' },
    { product: 'pharmacymoh', district: 'Belait', chargeCode: 'Self Collect', price: 4, note: 'Next working day after medicine collected from Pharmacy' },
    ...
    { product: 'pharmacyjpmc', district: 'Brunei', chargeCode: 'Standard', price: 4, note: '2-3 working days after medicine collected from Pharmacy' },
    { product: 'pharmacyjpmc', district: 'Tutong', chargeCode: 'Standard', price: 8, note: '2-3 working days after medicine collected from Pharmacy' },
    { product: 'pharmacyjpmc', district: 'Belait', chargeCode: 'Standard', price: 8, note: '2-3 working days after medicine collected from Pharmacy' },
    { product: 'pharmacyjpmc', district: 'Temburong', chargeCode: 'Standard', price: 11, note: '2-3 working days after medicine collected from Pharmacy' },
    { product: 'pharmacyjpmc', district: 'Brunei', chargeCode: 'Self Collect', price: 4, note: 'Next working day after medicine collected from Pharmacy' },
    { product: 'pharmacyjpmc', district: 'Tutong', chargeCode: 'Self Collect', price: 4, note: 'Next working day after medicine collected from Pharmacy' },
    { product: 'pharmacyjpmc', district: 'Temburong', chargeCode: 'Self Collect', price: 4, note: 'Next working day after medicine collected from Pharmacy' },
    { product: 'pharmacyjpmc', district: 'Belait', chargeCode: 'Self Collect', price: 4, note: 'Next working day after medicine collected from Pharmacy' },
